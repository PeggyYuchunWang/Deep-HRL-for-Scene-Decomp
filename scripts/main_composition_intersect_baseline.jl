...
solver = DeepQLearningSolver(qnetwork = model, max_steps=300_000,
                             ...
                             logdir="log/composition_intersection_policy_baseline_final1/", batch_size=128)
...
@save "weights/comp_baseline_policy_weights_final1.jld2" weights
@load "weights/comp_baseline_policy_weights_final1.jld2" weights
