...
solver = DeepQLearningSolver(qnetwork = model, max_steps=1_000_000,
                             ...
                             logdir="log/composition_intersection_policy_baseline_3/", batch_size=128)
...
@save "policies/composition_intersection_policy_baseline_3.jld2" policy
@load "policies/composition_intersection_policy_baseline_3.jld2" policy
