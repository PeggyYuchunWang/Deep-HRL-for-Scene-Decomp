...
solver = DeepQLearningSolver(qnetwork = model, max_steps=100_000,
                             ...
                             logdir="log/composition_intersection_policy_baseline_test9/", batch_size=128)
...
@save "weights/comp_baseline_policy_weights_test9.jld2" weights
@load "weights/comp_baseline_policy_weights_test9.jld2" weights
