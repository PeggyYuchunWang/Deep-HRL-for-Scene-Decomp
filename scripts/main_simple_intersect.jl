...
solver = DeepQLearningSolver(qnetwork = model, max_steps=400_000,
                             ...
                             logdir="log/simple_intersection_yike2/", batch_size=128)
...
@save "weights/simple_intersection_policy_weights.jld2" weights
@load "weights/simple_intersection_policy_weights.jld2" weights
