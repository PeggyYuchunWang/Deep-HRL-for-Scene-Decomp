...
include("../src/mdps/simple_intersection_left.jl")
include("../src/utils/helpers.jl")
# using AutomotiveHRLSceneDecomp

mdp = DrivingIntersectLeftMDP()
...
solver = DeepQLearningSolver(qnetwork = model, max_steps=1_000_000,
                             ...
                             logdir="log/simple_intersection_left/", batch_size=128)
...
@save "policies/simple_intersection_left_policy.jld2" policy
@load "policies/simple_intersection_left_policy.jld2" policy
